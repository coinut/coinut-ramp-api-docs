...
| --- | --- | --- |
| Sandbox | `https://partner-sandbox.coinut.net` | Integration testing without live funds |
| Production | `https://ramp.ltcpay.com` | Live partner ramp transactions |
| Development | `https://partner.vdapp.cn` | Internal development environment, when assigned by Coinut |
