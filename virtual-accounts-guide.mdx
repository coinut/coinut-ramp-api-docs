...
| SGD | Local Account Number | `accountNumber`, `bankName`, `bankAddress` | Singapore |
| USD | Local Account Number / Wire Instructions | `accountNumber`, `bankName`, `bankAddress` | USA |
| Other currencies | Subject to partner enablement | Contact Coinut support for the exact banking fields | Varies by corridor |
...
<ParamField body="currency" type="string" required>
  The fiat currency: `AUD`, `EUR`, SG,USD or `GBP`
</ParamField>
